...
"cheat_partner" = "Have you ever cheated on your significant other?",
...
steakdata4 <- steakdata3 %>%
  ...
  mutate(cheat_partner = as.factor(cheat_partner)) %>%
...
steakdata4 <- steakdata4 %>% 
  filter(lottery == "Lottery A" & eat_steak == "Yes") %>%
  select(RespondentID, lottery, eat_steak, steak_prep)
